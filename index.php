...
<style>
body{color:#333;font-family:"segoe ui",Arial,sans-serif}#page{width:90%;margin:40px auto 0;padding:20px 0}h1{text-align:center}form{text-align:center;margin:40px 0}#url{width:100%;height:48px;font-size:18px;color:#888;background:#f2f2f2;border:0;padding:0 10px;outline:0;text-align:center;box-sizing:border-box}#url,#submit{transition:color,background .2s ease-out}
#url:focus{color:#000;background:#C7EAEA}#submit {margin:0;padding:8px 18px;font-size:16px;cursor:pointer;color:#fff;background:#49B584;border:0;border-radius:3px}#submit:hover{background:#209861}#submit:active{background:#118B53;padding:9px 18px 7px}.type{margin:15px;display:inline-block;vertical-align:middle;cursor:pointer}pre{font-family:monaco,consolas;font-size:13px;background:#f8f8f8;padding:10px;border:1px solid #e3e3e3;overflow-x:auto}@media screen and (max-width:1080px){#url{font-size:16px}pre{font-size:12px}}
</style>
</head>
...
<body>
	<div id="page">
		...
		<form action="test.php" method="get">
			<input id="url" name="url" type="text" placeholder="请在此输入视频地址">
